...
Router.post('/upload/:id',multerUpload, imageValidation, imageControlleur.uploadImage )
...
Router.get('/admin/getAllDeliveryBoy', deliveryBoyControlleur.getAllDeliveryBoy)
Router.get('/admin/getAllDeliveryBoy/profile/:id' ,deliveryBoyControlleur.getOneUser)
