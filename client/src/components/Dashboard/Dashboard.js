      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            {/* Chart */}
            <Route path="/admin/dashboard/Chart">
            ...
            {/* Recent Deposits */}
            <Route path="/admin/dashboard/Deposits">
          ...
          <Route
            path="/admin/dashboard/deliveryboy"
            exact
          ...
          <Route
            path="/admin/dashboard/deliveryboy/:id"
            exact
            render={(props) => <BoysDetail boys={boys} {...props} />}
          />
          <Box pt={4}>
            <Copyright />
          </Box>
